...
class LeakageResilientSecretSharing():
        ...
        def combine_lrShares(self, recoverlist: list):
                ...
                for data in recoverlist:
                        ...
                        recovered_data = base64.b64decode(data['ShareData'])
                        ...
                        recovered_priXr_bytes = recovered_priXr_json.encode('utf-8')
                ...
                for data in recoverlist:
                        ...
                        print(shareIndex, share_data_bytes)
